...
public class ClientUtil {
    ...
    public static void appendTxt2MsgListArea(String txt) {
        if (client.ui.SpringChatFrame.instance != null) {
            client.ui.SpringChatFrame.instance.appendSystemMessage(txt);
        } else if (ChatFrame.msgListArea != null) {
    ...
    /** 添加消息到SpringChat风格界面 */
    public static void appendMessage(common.model.entity.Message msg) {
        if (client.ui.SpringChatFrame.instance != null) {
            client.ui.SpringChatFrame.instance.appendMessage(msg);
        } else {
            // Fallback for old UI
            appendTxt2MsgListArea(msg.getMessage());
        }
    }
}
