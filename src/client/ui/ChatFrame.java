...
//			}
            ...
            sb.append(" ").append(df.format(msg.getSendTime())).append(" ")
                    ...
                    .append("(").append(msg.getFromUser().getId()).append(") ");
            if(this.rybqBtn.isSelected()){//私聊
                sb.append("私聊对").append(selectedUser.getNickname())
            ...
            // 添加调试日志
            System.out.println("=== 客户端发送消息调试信息 ===");
            System.out.println("发送者: " + msg.getFromUser().getNickname() + "(" + msg.getFromUser().getId() + ")");
            if(msg.getToUser() != null){
                System.out.println("接收者: " + msg.getToUser().getNickname() + "(" + msg.getToUser().getId() + ")");
                System.out.println("消息类型: 私聊");
            }else{
                System.out.println("接收者: null");
                System.out.println("消息类型: 群聊");
            }
            System.out.println("私聊复选框状态: " + rybqBtn.isSelected());
            System.out.println("==============================");
