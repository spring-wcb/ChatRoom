...
public class RequestProcessor implements Runnable {
    ...
    public void chat(Request request) throws IOException {
        ...
        // 添加调试日志
        System.out.println("=== \u804a\u5929\u6d88\u606f\u8c03\u8bd5\u4fe1\u606f ==="); // 聊天消息调试信息
        System.out.println("\u53d1\u9001\u8005: " + msg.getFromUser().getNickname() + "(" + msg.getFromUser().getId() + ")"); // 发送者
        if(msg.getToUser() != null){
            System.out.println("\u63a5\u6536\u8005: " + msg.getToUser().getNickname() + "(" + msg.getToUser().getId() + ")"); // 接收者
            System.out.println("\u6d88\u606f\u7c7b\u578b: \u79c1\u804a"); // 消息类型: 私聊
        }else{
            System.out.println("\u63a5\u6536\u8005: null"); // 接收者
            System.out.println("\u6d88\u606f\u7c7b\u578b: \u7fa4\u804a"); // 消息类型: 群聊
        }
        System.out.println("=======================");
        ...
        if(msg.getToUser() != null){ //私聊:只给私聊的对象返回响应
            ...
            if(io != null){
                ...
                System.out.println("\u79c1\u804a\u6d88\u606f\u5df2\u53d1\u9001\u7ed9\u7528\u6237ID: " + msg.getToUser().getId()); // 私聊消息已发送给用户ID
            }else{
                System.out.println("\u9519\u8bef: \u627e\u4e0d\u5230\u63a5\u6536\u8005\u7684IO\u8fde\u63a5\uff0c\u7528\u6237ID: " + msg.getToUser().getId()); // 错误: 找不到接收者的IO连接，用户ID
            }
            ...
            System.out.println("\u7fa4\u804a\u6d88\u606f\u5df2\u53d1\u9001\u7ed9 " + count + " \u4e2a\u7528\u6237"); // 群聊消息已发送给 X 个用户
        }
    }
